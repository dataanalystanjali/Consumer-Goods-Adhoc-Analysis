...
--- 2.Provide a report with all the unique product counts for each segment and sort them in descending order of product counts. 
...
--- 3.Follow-up: Which segment had the most increase in unique products in 2021 vs 2020? The final output contains these fields,
--- segment
--- product_count_2020
--- product_count_2021
--- difference
...
--- 4.Get the products that have the highest and lowest manufacturing costs. The final output should contain these fields
--- product_code 
--- product
--- manufacturing_cost
SELECT
...
--- 5. Generate a report which contains the top 5 customers who received an average high pre_invoice_discount_pct
...
--- This analysis helps to get an idea of low and high-performing months and take strategic decisions. The final report
...
--- 7.In which quarter of 2020, got the maximum total_sold_quantity? The final output contains these fields 
...
--- 10.What is the percentage of unique product increase in 2021 vs. 2020?
